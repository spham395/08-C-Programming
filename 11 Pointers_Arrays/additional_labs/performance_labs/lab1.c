/*
additional_labs/performance_labs/lab1.c
...
int main(void)
{
    ...
    -integer with some random number\
    -float array with 5 random floats\
    -string (char array) with your favoriate food (all lower case)
