...
loops are used to represent a method  of executing a statment, block, or algrorithm multiple times
...
three components in the head of the *for loop* define the loops actions and nyumber of iterations executed by the loop
