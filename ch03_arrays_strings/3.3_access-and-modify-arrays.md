...
ao access a single element of an array is referenced by index number (aka element number). an integer expression may be used as an index to reference the element of an array.
